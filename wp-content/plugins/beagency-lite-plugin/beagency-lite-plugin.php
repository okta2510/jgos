<?php
/*
Plugin Name: BeAgency Lite Plugin
Description: This plugin is required for BeAgency Lite theme.
Author:      BeTheme
Version:     1.1.0
...
class beAgencyLitePlugin {
    public static function init() {
        ...
        new $class;
		add_action( $plugin_hook, array( 'beAgencyLitePlugin', 'beagency_get_premium' ) );
    }

    public function __construct() {
		// Add Custom Menu plugin.
		require_once plugin_dir_path( __FILE__ ) . 'inc/custom-menu/array_column.php';
...
add_action( 'plugins_loaded', array( 'beAgencyLitePlugin', 'init' ) );
